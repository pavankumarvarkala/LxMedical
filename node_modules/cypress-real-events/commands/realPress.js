...
function realPress(keyOrShortcut, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const key of keyDefinitions) {
            ...
            yield fireCdpCommand_1.fireCdpCommand("Input.dispatchKeyEvent", Object.assign({ type: key.text ? "keyDown" : "rawKeyDown", modifiers }, key));
            if (key.code === "Enter") {
                yield fireCdpCommand_1.fireCdpCommand("Input.dispatchKeyEvent", {
                    type: "char",
                    unmodifiedText: "\r",
                    text: "\r",
                });
        ...
        yield Promise.all(keyDefinitions.map((key) => {
            return fireCdpCommand_1.fireCdpCommand("Input.dispatchKeyEvent", Object.assign({ type: "keyUp", modifiers }, key));
        }));
