...
describe('Scheduled Appointment Details Test cases',()=>{
    ...
    it('As a Admin the user should be navigated to the Appointment Details page of "Scheduled" appointment by clicking on the eye icon against that appointment',()=>{
        ...
        cy.xpath('//div[1]/form/div[5]/button').should('be.visible').should('have.text','Assign').click({force:true})
        cy.wait(5000)
    ...
    it('At "Appointment Reschedule" page each label and field should have proper label and validations',()=>{
        ...
        cy.xpath('//div[1]/form/div[1]/div[2]/div').should('be.visible')
        // cy.xpath('//div[1]/form/div[2]/button').should('be.visible').should('have.text','Reschedule')
    })
    it('After Selecting Appointment date, Appointment time and by clicking on Rescheduled button the Appointment should be rescheduled',()=>{
        // cy.xpath('//div[1]/form/div[1]/div[1]/div').should('be.visible').click()
        ...
        cy.xpath('//div[1]/form/div[2]/button').should('be.visible').should('have.text','Reschedule').click({force:true})
    })
    ...
    it('As a Admin the user can change the provider assigned by clicking on the change provider button',()=>{
        cy.xpath('//button[@textid="change.provider"]').scrollIntoView().should('be.visible').should('have.text','Change Provider').click()
        cy.wait(3000)
        ...
        cy.xpath('//div[1]/form/div[3]/button').should('be.visible').should('have.text','Assign').click({force:true})
        cy.wait(2000)
