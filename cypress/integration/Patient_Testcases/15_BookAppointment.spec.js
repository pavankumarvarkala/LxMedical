...
describe('Book Appointment module testcases',()=>{
    ...
    it('As a Patient the user should be navigated to the Book appointment page by clicking on "Book" button against the paticular patient.',()=>{
    ...
    it('As a Patient the user should be navigated to the service address edit page by clicking on edit symbol against the service address',()=>{
    ...
    it('As a Patient the user can able select the appointment date by clicking on calendar icon against the preferred appointment date field.',()=>{
        cy.get('.appearance-none').should('be.visible').click()
        cy.get(':nth-child(5) > .react-datepicker__day--030').click()
    
    })
    it('As a Patient the user can able to select the appointment time by checking the check boxes in preferred time slot.',()=>{
    ...
    it('As a Patient the user can add additional family members as per his membership plan by clicking on "Add another member" button.',()=>{
