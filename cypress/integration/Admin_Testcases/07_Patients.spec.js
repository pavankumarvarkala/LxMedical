...
describe('Patient management module test cases', ()=>{
    ...
    it('At patients page each label and field should have proper label and validations',()=>{
        cy.get('div.font-bold').should('be.visible').should('have.text','Patients')
    ...
    it('At Add New Patient page each label and field should have proper label and validations ', ()=>{
        cy.get('div:nth-child(9) > div > div > div.hidden>div:nth-child(1)>div').should('be.visible').should('have.text','Add New Patient').click()
    ...
    it('As a Admin the user can enable or disable any patient with the help of toggle icon under status',()=>{
     ...
     it('As a Admin the user can change the membership of the patient by clicking on the membership plan under subscription', ()=>{
        cy.get('tr:nth-child(1)>td:nth-child(4)>div>div:nth-child(2)').scrollIntoView().should('be.visible').click({force:true})
        cy.wait(5000)
        cy.get('div.hidden>div:nth-child(2)>div:nth-child(3)>button').click()
        cy.wait(5000)
        cy.get('tr:nth-child(1)>td:nth-child(4)>div>div:nth-child(1)').scrollIntoView().should('be.visible').click({force:true})
        cy.wait(5000)
        cy.get('div.hidden>div:nth-child(2)>div:nth-child(3)>button').click()
        cy.wait(5000)
